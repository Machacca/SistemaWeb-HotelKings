...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 style="font-family: 'Playfair Display', serif; font-weight: 700; color: #1a1a1a; margin: 0;">Nuevo Usuario</h1>
            <p class="text-muted mb-0">Registre un nuevo usuario con acceso al sistema</p>
        </div>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 25px; overflow: hidden;">
            ...
            <div class="bg-dark text-white px-4 py-3" style="border-radius: 25px 25px 0 0;">
                <h5 class="mb-0 font-weight-bold">
                    <i class="fas fa-user-plus mr-2 text-warning"></i> Registrar Usuario
                </h5>
                <small class="text-muted">Complete los datos del nuevo usuario</small>
            </div>
                ...
                <form method="POST" action="{{ route('usuarios.store') }}" id="formUsuario">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="small font-weight-bold text-muted ml-2">CONTRASEÑA</label>
                            <div class="input-group">
                                <input type="password" name="Password" id="password" class="form-control rounded-pill-left bg-light border-0 px-4" 
                                       placeholder="******" required style="border-radius: 50px 0 0 50px;">
                        ...
                        @else
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="p-3 bg-light d-flex align-items-center" style="border-radius: 15px;">
                                    ...
                                    <span class="font-weight-bold">{{ auth()->user()->hotel->Nombre ?? 'Sede Asignada' }}</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        ...
                        <button type="submit" class="btn btn-dark rounded-pill px-5 font-weight-bold shadow-sm">
                            <i class="fas fa-save mr-2 text-warning"></i> Guardar Usuario
                        </button>
                    </div>
                </form>
            </div>
