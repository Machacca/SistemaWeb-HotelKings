...
@section('title', 'Editar Canal de Reserva')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 style="font-family: 'Playfair Display', serif; font-weight: 700; color: #1a1a1a; margin: 0;">Editar Canal de Reserva</h1>
            <p class="text-muted mb-0">Actualice los datos del canal</p>
        </div>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 25px; overflow: hidden;">
            ...
            <div class="bg-dark text-white px-4 py-3" style="border-radius: 25px 25px 0 0;">
                <h5 class="mb-0 font-weight-bold">
                    <i class="fas fa-edit mr-2 text-warning"></i> Editar Canal
                </h5>
                <small class="text-muted">Modifique los datos del canal</small>
            </div>

            {{-- Cuerpo del formulario --}}
            <div class="card-body p-4">
                <form method="POST" action="{{ route('canales-reserva.update', $canal->IdCanal) }}" id="formCanalEdit">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="Nombre" class="form-control rounded-pill bg-light border-0 px-4" 
                                   value="{{ old('Nombre', $canal->Nombre) }}" required>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="descripcion" class="form-control rounded-15 bg-light border-0 px-4 py-3" 
                                      rows="3">{{ old('descripcion', $canal->descripcion) }}</textarea>
                        </div>
                    </div>
...
<script>
    document.getElementById('formCanalEdit').addEventListener('submit', function(e) {
